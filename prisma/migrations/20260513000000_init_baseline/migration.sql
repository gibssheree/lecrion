...
At line:1 char:1
+ & "C:\nvm4w\nodejs/node.exe" "C:\Users\gilbert\AppData\Roaming\npm/no ...
+ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : NotSpecified: (Loaded Prisma c...isma.config.ts.:St 
...
From and To inputs (1 `--from-...` and 1 `--to-...` must be provided):
  ...
  --from-schema            Path to a Prisma schema file, uses the datamodel for 
the diff
  --to-schema
...
Flags
  ...
  --script                 Render a SQL script to stdout instead of the default 
human readable summary (not supported on MongoDB)
  --exit-code              Change the exit code behavior to signal if the diff is 
empty or not (Empty: 0, Error: 1, Not empty: 2). Default behavior is Success: 0, 
Error: 1.
