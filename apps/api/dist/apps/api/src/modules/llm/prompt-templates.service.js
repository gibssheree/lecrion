...
let PromptTemplatesService = class PromptTemplatesService {
    constructor() {
        this.ROLES = ['customer', 'admin', 'cashier', 'support'];
    }
    buildSystemPrompt(role = 'customer', context = {}) {
        const { catalogContext = 'Belum ada data katalog.', cartContext = 'Keranjang kosong.', posContext = 'POS provider belum terhubung.', } = context;
